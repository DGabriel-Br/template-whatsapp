function criarBarra(var_nome, var_avatar) {
  ...
  // Encontrar o contêiner do Typebot
  var elementoPai = document.querySelector('typebot-standard').shadowRoot.querySelector('.typebot-container');
  ...
  name.innerHTML = `
    <span>${var_nome}</span>
    &nbsp<span style="float: right" data-testid="psa-verified" data-icon="psa-verified">

function criarBarra(var_nome, var_avatar) {
  ...
  name.className = "name";
  name.innerHTML = `
    <span>${var_nome}</span>&nbsp<span style="float: right" data-testid="psa-verified" data-icon="psa-verified" class="">
          ...
          iconContainer.innerHTML = `
            <svg id="checkIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 38.626 24.684" style="position: absolute; bottom: 0; right: 5px; z-index: 99" height="20" width="18">
              <g id="Grupo_1" data-name="Grupo 1" transform="translate(-708.9 -601.383)">
                <path fill="none" stroke="#07c654" stroke-linecap="round" stroke-width="3" d="M728.035,623.468l1.382,1.482,17.929-20.334" transform="translate(-1.937 -1.117)"/>
                <path fill="none" stroke="#07c654" stroke-linecap="round" stroke-width="3" d="M712.017,616.07l7.088,8.039,17.757-20.14" transform="translate(-1 -0.469)"/>
              </g>
            </svg>`;
